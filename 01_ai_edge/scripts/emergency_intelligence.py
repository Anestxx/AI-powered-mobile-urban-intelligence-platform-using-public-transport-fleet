...
class EmergencyIntelligence:
    ...
    def detect_emergency(self, detections):
        ...
        for detection in detections:
            ...
            if (
                class_name in self.EMERGENCY_CLASSES
        ...
        alert = {
            ...
            "source": "edge_emergency_intelligence",
            "bbox": best.get("bbox"),
            "status": "active",
    ...
    def generate_corridor(
        ...
        return {
            "status": "priority_corridor_active",
            ...
            "recommended_action": (
                ...
                "movement through upcoming intersections"
            ),

            "signal_action": "REQUEST_PRIORITY",

            "corridor_type": (
                "recommended_emergency_route"
            ),
